...
import { getCurrentUserRoleSession } from "../../resources/form-resource";
import { getPatientByQuery } from "../../resources/patient-resources";
...
const SearchPatient: React.FC = () => {
  ...
  async function onHandleChangeSearch(e) {
    if (e.currentTarget.value.trim().length >= 3) {
      getPatientByQuery(e.currentTarget.value).then((patients) => {
        setPatient(patients);
